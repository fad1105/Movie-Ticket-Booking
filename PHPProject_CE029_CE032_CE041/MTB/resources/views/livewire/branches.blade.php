<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6">
        ...
        <tr> 
        	<td class="border px-4 py-2">{{ $branch->user_id}}</td>
        	<td class="border px-4 py-2">{{ $branch->city_name}}</td>
        	<td class="border px-4 py-2">{{ $branch->address}}</td>
        	<td class="border px-4 py-2">{{ $branch->state}}</td>
        	<td class="border px-4 py-2">{{ $branch->pincode}}</td>
        </tr>
        @endforeach
        </tbody>
        </table>
